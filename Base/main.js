...
var open = Cookies.get("open")
    ...
    function DirA() {
    var website = document.getElementById("DirB")
    website.innerHTML = ` <table> <thead> <th scope="col">To Do</th> <th scope="col">Done %</th> </thead> <tbody id="Main Dir List"> <th scope="col" class="btn-success" id="main">Main Dir List</th> <th scope="col" class="btn-danger-3" id="main">100%</th> </tbody> <tbody id="Core Dir List"> <th scope="col" class="btn-success" id="main">Core Dir List</th> <th scope="col" class="btn-danger-3" id="main">85%</th> </tbody> <tbody id="Core Website Code"> <th scope="col" class="btn-success" id="main">Core Website Code</th> <th scope="col" class="btn-danger-2" id="main">75%</th> </tbody> <tbody id="Website form CSS"> <th scope="col" class="btn-success" id="other">Website Form CSS</th> <th scope="col" class="btn-danger-2" id="other">65%</th> </tbody> </table>`
    }
    function ADBlock(){

        if(document.getElementById("CjVvKDZpWBsx")) {
      console.log("d")
        } else {
            var Data_html = document.getElementById("html")
            Data_html.innerHTML = `<div class="card"><img src="http://magma-mc.net/Assets/img/adblock.png" class="icon"><h2>AdBlock</h2><p class="desc">Please Disable Your AdBlocker</p></div>`
